...
class VisualNovel:
    ...
    def __init__(self, root):
        ...
        self.label = tk.Label(root,
                              text="Добро пожаловать! Нажми кнопку внизу, чтобы игра запустилась! (Кстати, пока просто расслабься)",
                              wraplength=400, font=("Arial", 24))
        self.label.pack()

        self.button1 = tk.Button(root, text="Начать игру", command=self.gameinit, font=("Arial", 24))
        self.button1.pack()
    ...
    def at_the_school(self):
        ...
        for i in range(45):
            ...
            self.bossfight.config(
                text=f"Фух, вот ты и в школе. А как известно, школе нужно отдать все свое сосредоточение. Сосредоточься до максимума (100 очков) за 45 секунд! {time_school}",
                wraplength=400, font=("Arial", 24))
...
def show_emotion(value):
    ...
    if value < 20:
        emotion_image_path = "emo1.png"
    elif value < 40:
        emotion_image_path = "emo2.png"
    elif value < 60:
        emotion_image_path = "emo3.png"
    elif value < 80:
        emotion_image_path = "emo4.png"
    else:
        emotion_image_path = "emo5.png"
